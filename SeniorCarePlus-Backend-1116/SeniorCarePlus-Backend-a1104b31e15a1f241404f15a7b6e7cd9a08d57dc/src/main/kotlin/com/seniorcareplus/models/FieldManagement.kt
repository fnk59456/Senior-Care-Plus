...
data class CloudDataInfo(
    ...
    val sub_topic: SubTopic? = null,
    
    // 前端額外字段
    val content: String? = null,
    val name: String? = null,
    val fw_ver: String? = null,
    val pub_topic: PubTopic? = null,
    val upgrade: Upgrade? = null
)

@Serializable
data class PubTopic(
    val anchor_config: String? = null,
    val tag_config: String? = null,
    val location: String? = null,
    val message: String? = null,
    val ack_from_node: String? = null,
